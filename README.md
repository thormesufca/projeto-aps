...
compile.bat
```
Ao rodar esse arquivo, o banco de dados será construído. Se o usuário passar a flag `-s`, vai alimentar as tabelas com alguns dados de exemplo.
```cmd
compile.bat -s
```

Uma vez compilado, para sua execução, o usuário deve rodar o script
```cmd
 run.bat
```
