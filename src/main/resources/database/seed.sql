...
(2,  '00023456720238060050', 'TRABALHISTA', 'ATIVO',     'EXECUCAO',     '2023-05-20', '1a Vara do Trabalho de Juazeiro do Norte',    'Reclamacao trabalhista por verbas rescisorias nao pagas e horas extras',             15000.00, 12000.00, 1,    1200.00, '2026-01-17',  2),
...
(4,  '00045678920238060051', 'CIVEL',       'ARQUIVADO', 'LIQUIDACAO',   '2023-01-05', '1a Vara Civel de Barbalha',                   'Execucao de titulo extrajudicial referente a contrato de prestacao de servicos',     8500.00,   8500.00,  1,    850.00, '2026-02-07',   4),
...
(8,  '00089012320248060050', 'CIVEL',       'ATIVO',     'RECURSAL',     '2024-01-10', '3a Vara Civel de Juazeiro do Norte',          'Acao de rescisao contratual com pedido de devolucao de valores pagos',              120000.00, 95000.00, 1,    9500.00, '2026-03-05',  8),
(9,  '00090123420238060051', 'TRABALHISTA', 'ENCERRADO', 'EXECUCAO',     '2023-04-18', '1a Vara do Trabalho de Barbalha',             'Execucao de sentenca trabalhista com deposito judicial efetivado',                  18000.00,  16500.00, 1,    1650.00, '2026-02-21',  9),
...
(1,  '2026-01-08', NULL,         'FIXO',       5000.00,  'Contrato de representacao em acao de indenizacao',      'Pagamento em 3 parcelas mensais',        1,  1),
(2,  '2026-01-23', '2026-02-17', 'PERCENTUAL', 20.00,    'Contrato de representacao em reclamacao trabalhista',   'Percentual sobre o valor da condenacao', 2,  2),
(3,  '2026-02-05', NULL,         'FIXO',       8000.00,  'Contrato de defesa em acao penal',                     'Encerrado com absolvicao do cliente',    3,  3),
(4,  '2026-01-14', '2026-03-07', 'FIXO',       3000.00,  'Contrato de representacao em execucao de titulo',      'Processo arquivado apos quitacao',       4,  4),
(5,  '2026-02-19', NULL,         'PERCENTUAL', 25.00,    'Contrato de representacao em reclamacao por assedio',  'Honorarios de exito de 25%',             5,  5),
(6,  '2026-03-03', NULL,         'FIXO',       12000.00, 'Contrato de representacao em acao de cobranca',        'Inclui acompanhamento de pericia',       6,  6),
(7,  '2026-01-30', NULL,         'FIXO',       15000.00, 'Contrato de defesa criminal - trafico de drogas',      'Pagamento mensal de R$ 1.500,00',        7,  7),
(8,  '2026-02-11', '2026-04-05', 'PERCENTUAL', 15.00,    'Contrato de representacao em acao de rescisao',        'Percentual sobre valores recuperados',   8,  8),
(9,  '2026-03-17', '2026-03-21', 'PERCENTUAL', 20.00,    'Contrato de execucao de sentenca trabalhista',         'Processo encerrado com exito',           9,  9),
(10, '2026-02-26', NULL,         'FIXO',       20000.00, 'Contrato de defesa criminal na administracao publica', 'Pagamento antecipado integral',          10, 10);


INSERT INTO audiencias (id, descricao, data_hora, local, tipo, status, resultado, observacoes, processo_id) VALUES
(1,  'Audiencia de Conciliacao - Indenizacao por acidente',        '2026-04-09 09:00:00', '2a Vara Civel de Juazeiro do Norte',                   'CONCILIACAO', 'AGENDADA',  'Acordo nao obtido, prosseguimento da instrucao',              'Partes presentes|Tentativa de acordo fracassada|Designada audiencia de instrucao', 1),
(2,  'Audiencia de Instrucao - Verbas Trabalhistas',               '2026-04-27 14:00:00', '1a Vara do Trabalho de Juazeiro do Norte',              'INSTRUCAO',   'AGENDADA',  NULL,     NULL, 2),
(3,  'Audiencia de Julgamento - Recurso Criminal',                 '2026-02-06 10:00:00', 'Tribunal de Justica do Ceara - Camara Criminal',        'JULGAMENTO',  'REALIZADA',  'Absolvicao mantida por unanimidade',                         'Sessao de julgamento do recurso ministerial|Placar 3x0 favoravel a defesa', 3),
(4,  'Audiencia Preliminar - Execucao de Titulo',                  '2026-02-13 08:30:00', '1a Vara Civel de Barbalha',                             'PRELIMINAR',  'REALIZADA',  'Citacao do executado realizada, prazo para embargos',        'Executado citado pessoalmente|Prazo de 15 dias para embargos', 4),
(5,  'Audiencia de Conciliacao - Assedio Moral',                   '2026-02-24 09:30:00', '2a Vara do Trabalho de Juazeiro do Norte',              'CONCILIACAO', 'AGENDADA',   NULL,                                                         'Primeira tentativa de conciliacao|Partes notificadas por AR', 5),
(6,  'Audiencia de Instrucao - Acao de Cobranca',                 '2026-03-04 15:00:00', '2a Vara Civel de Crato',                                'INSTRUCAO',   'CANCELADA',  NULL,                                                         'Cancelada por ausencia do perito nomeado|Remarcar em nova data', 6),
(7,  'Audiencia de Instrucao - Acao Penal Trafico',               '2026-04-16 08:00:00', '2a Vara Criminal de Juazeiro do Norte',                 'INSTRUCAO',   'AGENDADA',  NULL,      'Reu presente|Defensor constituido presente|4 testemunhas ouvidas', 7),
(8,  'Sessao de Julgamento - Recurso Civel',                      '2026-03-12 10:00:00', 'Tribunal de Justica do Ceara - 3a Camara Civel',        'JULGAMENTO',  'REALIZADA',  'Recurso provido parcialmente, valor reduzido para R$ 95.000', 'Sessao presidida pelo Des. Relator|Votacao unanime', 8),
(9,  'Audiencia de Julgamento - Execucao Trabalhista',            '2026-03-20 09:00:00', '1a Vara do Trabalho de Barbalha',                       'JULGAMENTO',  'REALIZADA',  'Deposito judicial realizado, processo encaminhado para baixa', 'Credor levantou os valores|Devedor quitou integralmente', 9),
(10, 'Audiencia Preliminar - Crime Contra a Administracao',        '2026-02-18 14:00:00', '1a Vara Criminal de Crato',                             'PRELIMINAR',  'CANCELADA',  NULL,                                                         'Cancelada por habeas corpus preventivo|Aguardando decisao do STJ', 10);
